...
class VoxelEngine:
    ...
    def on_init(self): 
        ...
        Should only be called on object init.
        """

        self.textures = Textures(self) # Create textures object
        self.player = Player(self) # Create player object
        self.shader_program = ShaderProgram(self) # Create shader program object
        self.scene = Scene(self) # Create scene object
    ...
    def run(self):
        ...
        Should be called only once when starting the game.
        """
